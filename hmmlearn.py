...
HMM_1 = HiddenMarkovModel(f)
HMM_1.train()

model=[]
model.append(HMM_1.tag_set)
model.append(HMM_1.tagvstag)
model.append(HMM_1.wordvstag)
model.append(HMM_1.oc_tags)
f_write = open('hmmmodel.txt', mode = 'w', encoding = 'UTF-8')
f_write.write(json.dumps(model))
f_write.close()
